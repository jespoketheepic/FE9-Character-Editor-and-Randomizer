...
public class PromotedFEClass implements FEPromoClass {
    ...
    public PromotedFEClass(String displayName, String JID_name, byte[] JID_pointer, String AID1_name, byte[] AID1_pointer, String AID2_name, byte[] AID2_pointer, String IID_name, byte[] IID_pointer, int frequency) {
    ...
    public PromotedFEClass(String[] parameters){
    ...
    public boolean isPromoted() { return true; }
